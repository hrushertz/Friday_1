...
def easter01():
    try:
        speak(
            "I am Friday, designed to work under guidence of Jarvis, but unfortunately, as Jarvis is no more with us I was assigned to handle the daily takes")
...
def weather(term):
    try:
        ...
        if x["cod"] != "404":
            ...
            print("descripiton = " + str(weather_description))
            speak("descripiton = " + str(weather_description))
        else:
